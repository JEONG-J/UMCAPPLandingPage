...
const TeamSection = () => {
  ...
  const members = [
    { id: 1, name: '정의찬 (제옹)', role: 'Team Leader / PM / iOS Design / iOS', stack: 'SwiftUI, CreateML, Network Architecture', comment: '기획, 디자인, 개발을 아우르며 팀을 이끕니다. 👑 ', image: jeongImg, social: { github: 'https://github.com/JEONG-J', linkedin: '#', blog: 'https://medium.com/@euijjang97', instagram: 'https://www.instagram.com/eui_chan.97/' } },
    { id: 2, name: '이재원 (리버)', role: 'Vice Leader / iOS Leader', stack: 'SwiftUI, CleanArchitecture, MapKit, CoreLocation', comment: 'iOS 파트를 이끌고 있습니다. 🍎', image: riverImg, social: { github: 'https://github.com/jwon0523', linkedin: '#', blog: 'https://velog.io/@jwlee010523/posts', instagram: 'https://www.instagram.com/jwon__01/' } },
    ...
    { id: 4, name: '박유수 (어헛차)', role: 'Android Leader', stack: 'Kotlin', comment: '안드로이드 개발을 리딩합니다. 🤖', image: euheotchaImg, social: { github: 'https://github.com/Park-yu-su', linkedin: '', blog: 'https://blog.naver.com/PostList.naver?blogId=uhutcha_7130', instagram: 'https://www.instagram.com/you_water0130' } },
    ...
    { id: 6, name: '김미주 (마티)', role: 'iOS Developer', stack: 'Swift, SwiftUI, ', comment: '중요한 소식을 놓치지 않도록 만드는 사람입니다. 🔔', image: martiImg, social: { github: 'https://github.com/alwn8918', linkedin: '#', blog: '#', instagram: 'https://www.instagram.com/miju__03/' } },
    { id: 7, name: '이예지 (소피)', role: 'iOS Developer', stack: 'Swift, SwiftUI', comment: '사용자들이 소통하는 공간을 만듭니다. 🗨️    ', image: sophieImg, social: { github: 'https://github.com/LeeYeJi546', linkedin: '#', blog: '#', instagram: 'https://www.instagram.com/2_dpwl/' } },
    { id: 8, name: '양지애 (나루)', role: 'Android Developer', stack: 'Kotlin, Android SDK', comment: '앱이 끊김 없이 돌아가도록 다듬는 사람입니다. ⚙️  ', image: naruImg, social: { github: 'https://github.com/yangjiae12', linkedin: '#', blog: '#', instagram: 'https://www.instagram.com/odlwdxd' } },
    { id: 9, name: '조경석 (조나단)', role: 'Android Developer', stack: 'Kotlin, Coroutines, Multi-Module', comment: '얽힌 로직을 모듈 단위로 풀어내는 사람입니다. 🧱', image: jonathanImg, social: { github: 'https://github.com/rudtjr1106', linkedin: '#', blog: 'https://velog.io/@rudtjr1106/posts', instagram: '#' } },
    { id: 10, name: '김도연 (도리)', role: 'Android Developer', stack: 'Kotli', comment: '안드로이드 UI 컴포넌트와 화면 흐름을 구현합니다. ✨', image: doriImg, social: { github: 'https://github.com/rudtjr1106', linkedin: '#', blog: '#', instagram: 'https://www.instagram.com/doyeon9394' } },
    { id: 11, name: '강하나 (와나)', role: 'Server Developer', stack: 'SpringBoot, Redis, Spring Security', comment: '데이터를 정리하고 꺼내주는 사람입니다. 📦', image: wanaImg, social: { github: 'https://github.com/kanghana1', linkedin: '#', blog: 'https://wanna-developer02.tistory.com/', instagram: 'https://www.instagram.com/one_river_02' } },
    { id: 12, name: '박지현 (박박지현)', role: 'Server Developer', stack: 'SpringBoot, Nest.js', comment: '사용자가 안심하고 쓸 수 있는 서비스를 만듭니다. 🔐', image: parkparkImg, social: { github: 'https://github.com/wlgusqkr', linkedin: 'https://www.linkedin.com/in/%EC%A7%80%ED%98%84-%EB%B0%95-456b9835b/', blog: '#', instagram: 'https://www.instagram.com/wlgourldl' } },
    { id: 13, name: '박세은 (세니)', role: 'Server Developer', stack: 'SpringBoot, Docker, Redis', comment: '안정적인 서버 환경을 설계하고 운영합니다. 🛠️', image: seniImg, social: { github: 'https://github.com/ParkSenn', linkedin: '#', blog: '#', instagram: 'https://www.instagram.com/0sensen0/' } },
    { id: 14, name: '이예은 (스읍)', role: 'Server Developer', stack: 'SpringBoot', comment: '앱이 숨 쉴 수 있도록 API를 만드는 사람입니다. 🫁', image: seueupImg, social: { github: 'https://github.com/sopp1313', linkedin: '#', blog: '#', instagram: 'https://www.instagram.com/_yeeeeeun' } }
  ];
